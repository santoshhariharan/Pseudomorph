...
%     line(coord(1,:),coord(2,:),'Linewidth',v(i)*1,'Color',[.4 .4 .4]); 
% end
for i = 1:max(mGrp)
    ii = mGrp == i;
...
%% View data
viewMSTPie2(mCent3,disMat,maps,[r c],v,.05,radiusCls);
return;
